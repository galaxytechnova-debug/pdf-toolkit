...
export default function PdfToWordPage() {
  ...
  async function onFiles(files) {
    ...
    setBusy(true);
    try {
      const blob = await postMultipart("pdf-to-word", { file: f });
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-10">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold tracking-tight text-zinc-900 mb-2">PDF to Word</h1>
        <p className="text-zinc-500">Edit your PDF content by converting it to DOCX.</p>
      </div>
      ...
      <UploadArea
        ...
        description="Drag & drop a PDF to convert to Word"
        color="fuchsia"
      />
      {busy && <div className="mt-8 text-center animate-pulse text-fuchsia-600 font-medium">Converting to Word...</div>}
