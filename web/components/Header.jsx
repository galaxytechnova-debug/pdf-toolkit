...
const groups = [
  ...
  {
    label: "Images",
    items: [{ href: "/compress-image", label: "Compress Image", Icon: ImageIcon, bg: "bg-cyan-50", fg: "text-cyan-600" }],
  },
];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between gap-4">
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <span className="text-lg font-bold tracking-tight bg-linear-to-r from-indigo-600 to-violet-600 bg-clip-text text-transparent">Pro PDF Toolkit</span>
            </Link>
      ...
      >
        <div className="flex h-16 items-center justify-between border-b border-zinc-100 px-6 bg-white/50 backdrop-blur-xl">
          <Link href="/" className="flex items-center gap-2 group" onClick={() => setMobileOpen(false)}>
            ...
            <span className="text-base font-bold tracking-tight bg-linear-to-r from-indigo-600 to-violet-600 bg-clip-text text-transparent">Pro PDF Toolkit</span>
          </Link>
          <button
            onClick={() => setMobileOpen(false)}
